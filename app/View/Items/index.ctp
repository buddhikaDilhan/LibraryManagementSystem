<div class="items index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('borrowed'); ?></th>
			<th><?php echo $this->Paginator->sort('received_as'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($items as $item): ?>
	<tr>
		<td><?php echo h($item['Item']['id']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['borrowed']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['received_as']); ?>&nbsp;</td>
		<td class="actions">
