<div class="locations index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('shelve_ID'); ?></th>
			<th><?php echo $this->Paginator->sort('row_number'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($location['Location']['shelve_ID']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['row_number']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['section']); ?>&nbsp;</td>
		<td class="actions">
