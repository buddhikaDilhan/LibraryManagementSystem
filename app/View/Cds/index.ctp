<div class="cds index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $cd['Cd']['item_id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $cd['Cd']['item_id']), null, __('Are you sure you want to delete # %s?', $cd['Cd']['item_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
